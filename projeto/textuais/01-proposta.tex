...
com corrupção possui uma execução de controle correspondente, que deve ser
idêntica a ela em arquitetura, partição, semente, número de épocas e ajustes de
regularização, diferindo \emph{apenas} pela presença da corrupção --- de modo
que a semente que governa o ruído é separada daquela que governa a partição e a
inicialização. O rigor desse pareamento é condição de validade do experimento:
qualquer diferença adicional entre os grupos, como a presença de aumento de
dados em apenas um deles, torna o contraste observado atribuível a mais de uma
causa.
